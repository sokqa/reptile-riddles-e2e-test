...
Outcome of test session: Test report

Test report to be presented
- by: tester who performed exploratory testing
- to: project manager, product owner, test lead, dev lead

Results to be considered during next sprint planning.
